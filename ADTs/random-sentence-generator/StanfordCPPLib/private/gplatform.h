...
class GPlatform {
public:
   int createGWindow(double width, double height);
   void closeGWindow(int id);
   void clear(int id);
   void repaint(int id);
   ...
   double getFontHeight(int id);
   double getFontAscent(int id);
   double getFontDescent(int id);
