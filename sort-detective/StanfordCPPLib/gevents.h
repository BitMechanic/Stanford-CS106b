 ...
 *        GActionEvent actionEvent(type, gw, actionCommand);
 * ---------------------------------------------------------
 ...
 */
   ...
   GActionEvent(ActionEventType type, GWindow *gw, std::string actionCommand);
 ...
 *        GKeyEvent keyEvent(type, gw, key);
 * -----------------------------------------
 ...
 */
   ...
   GKeyEvent();
   GKeyEvent(GEvent e);
   GKeyEvent(KeyEventType type, GWindow *gw, int key);
