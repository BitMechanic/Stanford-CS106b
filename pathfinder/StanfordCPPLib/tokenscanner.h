...
enum TokenType { SEPARATOR, IDENTIFIER, NUMBER, STRING, OPERATOR };
...
/*
 * Method: addIdentifierCharacters
 * Usage: scanner.addIdentifierCharacters(str);
 * --------------------------------------------
 * Adds the characters in <code>str</code> to the set of legal identifier
 * characters.  For example, calling <code>addIdentifierCharacters("_")</code>
 * adds the underscore to the set of identifier characters.
 */

   void addIdentifierCharacters(string str);

/*
 * Method: isIdentifierCharacter
 * Usage: if (scanner.isIdentifierCharacter(ch)) . . .
 * ---------------------------------------------------
 * Returns <code>true</code> if the character is valid in an identifier.
 */

   bool isIdentifierCharacter(char ch) const;
 ...
 * <code>SEPARATOR</code>, <code>IDENTIFIER</code>, <code>NUMBER</code>,
 ...
 */
   ...
   std::string getStringValue(string token) const;
...
private:
   ...
   std::string identifierChars;     /* Extra identifier characters  */
